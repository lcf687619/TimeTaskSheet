 ...
 * 
 */
public class SwipeMenuLayoutForScrollView extends FrameLayout {
	...
	private SwipeMenuViewForScrollView mMenuView;
	private int mDownX;
	...
	public SwipeMenuLayoutForScrollView(View contentView, SwipeMenuViewForScrollView menuView) {
	...
	private SwipeMenuLayoutForScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	private SwipeMenuLayoutForScrollView(Context context) {
		super(context);
	}
	...
	public SwipeMenuViewForScrollView getMenuView() {
		return mMenuView;
	}
