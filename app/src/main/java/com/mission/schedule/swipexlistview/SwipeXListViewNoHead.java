...
public class SwipeXListViewNoHead extends ListView implements OnScrollListener {
...
//	private SwipeXListViewFooter mFooterView;
	...
	public SwipeXListViewNoHead(Context context) {
		this(context, null);
		initWithContext(context);
	}

	public SwipeXListViewNoHead(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initWithContext(context);
	}

	public SwipeXListViewNoHead(Context context, AttributeSet attrs, int defStyle) {
...
//	public void setUpDown(RelativeLayout up_down){
