...
public class RepeatSwipeXListView extends ListView implements OnScrollListener {
	...
	// -- header view
	private SwipeXListViewHaveHeader mHeaderView;
...
//	ProgressBar xlistview_header_progressbar ;										// feature.
	
	private int source;
	public static RepeatGridView gridView = null;

	public RepeatSwipeXListView(Context context) {
		this(context, null);
		initWithContext(context);
	}

	public RepeatSwipeXListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initWithContext(context);
	}

	public RepeatSwipeXListView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initWithContext(Context context) {
		...
		// init header view
		mHeaderView = new SwipeXListViewHaveHeader(context);
		mHeaderViewContent = (LinearLayout) mHeaderView
				.findViewById(R.id.xlistview_header_content);
		gridView = null;
		gridView = (RepeatGridView) mHeaderView.findViewById(R.id.tuijian_gv);
//		mHeaderTimeView = (TextView) mHeaderView
//				.findViewById(R.id.xlistview_header_time);
//		xlistview_header_progressbar = (ProgressBar) mHeaderView.findViewById(R.id.xlistview_header_progressbar);
		...
		mHeaderView.getViewTreeObserver().addOnGlobalLayoutListener(
				new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						...
						System.out.println("mHeaderheight:"
...
//	}
	...
	private void updateHeaderHeight(float delta) {
		mHeaderView.setVisiableHeight((int) (1.2*delta)
...
//				mFooterView.setBottomMargin(mScroller.getCurrY());
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (rightListener != null)
				rightListener.onRightViewWidth(motionPosition);
			if (motionPosition >= 0) {
	...
	private void headAlpha(){
		
		if(mHeaderView.getVisiableHeight() <= mHeaderViewHeight&&mHeaderView.getVisiableHeight()>0){
			float alphaUp=(float)mHeaderView.getVisiableHeight()/(float)mHeaderViewHeight;
			float alphaDown=(float)(mHeaderViewHeight-mHeaderView.getVisiableHeight())/(float)mHeaderViewHeight;
			up_show.setAlpha(alphaUp);
			up_down.setAlpha(alphaDown);
		}
	}
...
//			}
		...
		case MotionEvent.ACTION_CANCEL:
			...
			if (mHeaderView.getVisiableHeight() < mHeaderViewHeight||lastY - mFirstY<0) {
				stopRefresh();
				up_show.setAlpha(0);
				up_down.setAlpha(1);
			}
...
//				resetFooterHeight();
	...
	public void setUpDown(LinearLayout up_down){
		this.up_down=up_down;
	}
	
	public void setUpshow(TextView up_show){
		this.up_show=up_show;
	}
