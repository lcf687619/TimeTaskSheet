...
public class PullToRefreshViewNoFooter extends LinearLayout {
...
//	 private TextView mFooterUpdateTextView;
	...
	public PullToRefreshViewNoFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullToRefreshViewNoFooter(Context context) {
		super(context);
		init();
	}
...
//				.findViewById(R.id.pull_to_load_text);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_CANCEL:
			...
			System.out.println(event.getAction() + " --- mPullState -- "
					+ mPullState + " -- " + topMargin);
			if (mPullState == PULL_DOWN_STATE) {
				if (topMargin >= 0) {
					// 开始刷新
					headerRefreshing();
...
//		mFooterTextView.setText("加载中\u2026");
	...
	public void onHeaderRefreshComplete() {
		...
		// mHeaderImageView.setImageResource(R.drawable.pull_down);
		mHeaderTextView.setText("下拉刷新");
...
//		 mHeaderUpdateTextView.setText("");
	...
	public void onFooterRefreshComplete() {
		...
		// mFooterImageView.setImageResource(R.drawable.pull_up);
//		mFooterTextView.setText("加载更多");
