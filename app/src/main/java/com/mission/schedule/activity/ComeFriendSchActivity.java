...
public class ComeFriendSchActivity extends BaseActivity implements OnClickListener{
	...
	protected void setContentView() {
		setContentView(R.layout.activity_comefriendsch);
	}

	@Override
	protected void init(Bundle savedInstanceState) {
		headtitle_tv.setText("收到的提醒");
		init();
