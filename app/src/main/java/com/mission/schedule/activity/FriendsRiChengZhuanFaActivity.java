...
public class FriendsRiChengZhuanFaActivity extends BaseActivity implements
		OnClickListener {
	...
	protected void init(Bundle savedInstanceState) {
		...
		riChengBean = (FriendsRiChengBean) getIntent().getSerializableExtra(
				"bean");
		LoadData();
	}
		...
		friends_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				app.insertMessageSendData(Integer.parseInt(userId),
						friendsBean.fId, 0, riChengBean.COpenstate, 1,
						riChengBean.CIsAlarm, riChengBean.CPostpone, 0,
						riChengBean.CDisplayAlarm, riChengBean.CBefortime, 0,
						0, 0, 0, 0, 0, 0, "", riChengBean.CContent,
						riChengBean.CDate, riChengBean.CTime, "", "", "",
						riChengBean.CAlarmsoundDesc, riChengBean.CAlarmsound,
						"", riChengBean.CCreateTime, "", "",
						riChengBean.webUrl, riChengBean.imgPath, userName, "",
						1, 0, 0, "", 0, 0, "", 0, "",
