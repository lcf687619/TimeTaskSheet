...
public class NewFocusShareRiChengActivity extends BaseActivity implements
	...
	protected void setContentView() {
		setContentView(R.layout.activity_newfocussharericheng);
	}
				...
				if (!"0".equals(mMap.get(CLFindScheduleTable.fstRepeatId))
					...
					if(Integer.parseInt(mMap.get(CLFindScheduleTable.fstRepeatId))<0){
						if (NewFocusShareRepeatActivity.focusRepList != null
								&& NewFocusShareRepeatActivity.focusRepList.size() > 0) {
