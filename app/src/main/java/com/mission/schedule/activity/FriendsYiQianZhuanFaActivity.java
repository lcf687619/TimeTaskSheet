...
public class FriendsYiQianZhuanFaActivity extends BaseActivity implements
		OnClickListener {
	...
	protected void init(Bundle savedInstanceState) {
		...
		yiQianBean = (FriendsYiQianBean) getIntent().getSerializableExtra(
				"bean");
		LoadData();
	}
		...
		friends_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				app.insertMessageSendData(Integer.parseInt(userId),
						friendsBean.fId, 0, yiQianBean.COpenstate, 1,
						yiQianBean.CIsAlarm, yiQianBean.CPostpone, 0,
						yiQianBean.CDisplayAlarm, yiQianBean.CBefortime, 0, 0,
						0, 0, 0, 0, 0, "", yiQianBean.CContent,
						yiQianBean.CDate, yiQianBean.CTime, "", "", "",
						yiQianBean.CAlarmsoundDesc, yiQianBean.CAlarmsound, "",
						yiQianBean.CCreateTime, "", "", yiQianBean.webUrl,
						yiQianBean.imgPath, userName, "", 1, 0, 0, "", 0, 0,
