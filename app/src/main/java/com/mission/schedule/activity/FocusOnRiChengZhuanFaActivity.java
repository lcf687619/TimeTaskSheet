...
public class FocusOnRiChengZhuanFaActivity extends BaseActivity implements
		OnClickListener {
	...
	protected void init(Bundle savedInstanceState) {
		...
		myName = prefUtil.getString(context, ShareFile.USERFILE,
				ShareFile.USERNAME, "");
		circleBean = (FocusOnAllBean) getIntent().getSerializableExtra("bean");
		LoadData();
	}
		...
		friends_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				app.insertMFMessageSendData(Integer.parseInt(userId),
						friendsBean.fId, circleBean.cIsAlarm, 0, 0, 0,
						circleBean.cDisplayAlarm, circleBean.cBeforTime, 0, 0,
						"", circleBean.cContent, DateUtil.formatDateTimeSs(new Date()),
