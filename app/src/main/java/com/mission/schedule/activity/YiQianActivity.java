...
import com.mission.schedule.adapter.YiQianAdapter;
...
public class YiQianActivity extends BaseActivity implements OnClickListener,
		OnItemClickListener {

	@ViewResId(id = R.id.top_ll_back)
	private LinearLayout top_ll_back;
	@ViewResId(id = R.id.yiqian_listview)
	private SwipeXListViewNoHead yiqian_listview;
	...
	protected void setListener() {
		...
		yiqian_listview.setPullLoadEnable(false);
	}

	@Override
	protected void setContentView() {
		setContentView(R.layout.activity_yiqian);
	}
	...
	protected void init(Bundle savedInstanceState) {
		...
		yiqian_listview.addFooterView(footView);
		loadData();
	}
	...
	protected void setAdapter() {
		adapter = new YiQianAdapter(context, mList,
				R.layout.adapter_guoqiweijieshu, handler, yiqian_listview,
				mScreenWidth);
		yiqian_listview.setPullLoadEnable(false);
		yiqian_listview.setPullRefreshEnable(false);
		yiqian_listview.setAdapter(adapter);
	}
		...
		public void onClick(View v) {
			...
			case R.id.more_setdaiban:// 设为待办 今天+全天+顺延
				try {
					...
					adapter.notifyDataSetChanged();
					// yiqian_listview.setSelectionFromTop(scrolledX,
					// scrolledY);
					RefreshMyData();
				} catch (Exception e) {
					e.printStackTrace();
