...
public class EditNewFocusShareShowContentActivity extends BaseActivity implements OnClickListener{
	...
	protected void setAdapter() {
		...
		modle_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				contentdesc = modle_lv.getAdapter().getItem(position)
						.toString();
				if ("".equals(contentdesc)) {
					return;
				} else {
					if ("全部↑".equals(contentdesc)) {
						contentstr = "0";
					} else if ("全部↓".equals(contentdesc)) {
						contentstr = "2";
					} else {
						contentstr = "1";
					} 
