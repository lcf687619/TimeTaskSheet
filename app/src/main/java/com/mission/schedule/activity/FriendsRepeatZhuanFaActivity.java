...
public class FriendsRepeatZhuanFaActivity extends BaseActivity implements
		OnClickListener {
		...
		friends_lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				friendsBean = (FriendsBean) friends_lv.getAdapter().getItem(
						position);
				boolean fag = app.insertMessageSendData(
						Integer.parseInt(userId), friendsBean.fId, 0,
						chongFubean.repOpenState, 2, chongFubean.repIsAlarm, 0,
						0, chongFubean.repDisplayTime,
						chongFubean.repBeforeTime, chongFubean.repSourceType,
						chongFubean.repType, 0, 0, 0, 0, 0,
						chongFubean.repTypeParameter, chongFubean.repContent,
						DateUtil.formatDate(new Date()), chongFubean.repTime,
						chongFubean.repSourceDesc,
						chongFubean.repSourceDescSpare, "",
						...
						chongFubean.repNextCreatedTime, chongFubean.webUrl,
						chongFubean.imgPath, userName, "", 1, 0, 0, "", 0, 0,
						"", 0, chongFubean.parReamrk, DateUtil.formatDateTimeSs(new Date()));
				ID = app.nfmId;
				if (fag) {
					app.insertMessageSendData(Integer.parseInt(userId),
							friendsBean.fId, 0, chongFubean.repOpenState, 1,
							chongFubean.repIsAlarm, 0, 0,
							chongFubean.repDisplayTime,
							chongFubean.repBeforeTime,
							chongFubean.repSourceType, 0, chongFubean.aType, 0,
							0, 0, 0, "", chongFubean.repContent,
							DateUtil.formatDate(new Date()),
							chongFubean.repTime, chongFubean.repSourceDesc,
							chongFubean.repSourceDescSpare, "",
							chongFubean.repRingDesc, chongFubean.repRingCode,
							"", "", "", "", chongFubean.webUrl,
							chongFubean.imgPath, userName, "", 0, ID, 0,
							"", 0, 0, "", 0, "",
	...
	private void UpdateLoadData() {
		...
		if (NetUtil.getConnectState(context) != NetWorkState.NONE) {
			...
			app.deleteNewFriendsChildData(ID);
			alertFailDialog();
		}
	}
