...
public class TagSchSerachActivity extends BaseActivity implements OnClickListener{
	...
	protected void setContentView() {
		setContentView(R.layout.activity_tagschserach);
	}
