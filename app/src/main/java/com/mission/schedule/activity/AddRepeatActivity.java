...
public class AddRepeatActivity extends BaseActivity implements OnClickListener {
				...
				try {
					...
					if ("每天".equals(date_tv.getText().toString())) {
						...
						flag = app.insertCLRepeatTableData(before, coclor,
								...
								"", "", 0, 0, urlstate, url, "",
								Integer.parseInt(repselectstate), 0, parstr, 0,
								0);
						...
						if ("0".equals(repselectstate)) {
							app.insertScheduleData(addrepeatcontent_et
									...
									isAlarm, before, timeState, 0, 0, coclor,
			...
			if (resultCode == Activity.RESULT_OK) {
				...
				if(!"".equals(strDay)){
					if(strDay.contains(",")){
						...
						dateselect_tv.setText(sb.toString() + "日");
					}else {
