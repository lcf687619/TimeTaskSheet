...
import com.mission.schedule.adapter.NewFocusMobleTwoQuanbuAdapter;
...
public class NewFocusMobleTwoActivity extends BaseActivity implements
        OnClickListener {
    ...
    NewFocusMobleTwoQuanbuAdapter quanBuAdapter = null;
    String path;
    String UserID;
...
//        }
        ...
        if ("".equals(StringUtils
                .getIsStringEqulesNull(friendsbackimage))) {
...
//				break;
                                ...
                                if (backBean.status == 0) {
                                    ...
                                    if (riChengList != null
                                        ...
                                        if (quanBuAdapter == null) {
                                            quanBuAdapter = new NewFocusMobleTwoQuanbuAdapter(
                                                    context,
                                                    allList,
                                                    R.layout.adapter_friendsricheng_moble_two,
    ...
    class RightOnClick implements OnClickListener {
        ...
        public void initview() {
            ...
            canel_tv = (TextView) view.findViewById(R.id.canel_tv);
            canel_tv.setOnClickListener(this);
            path = "http://www.keytimeapp.com/mytb/channel/space1.html?uid="
                    + friendId;
            title = othername;
            content = friendName;
            if (shoucangfag) {
