...
import com.mission.schedule.adapter.ComeNoEndSchAdapter;
...
public class ComeFriendNoEndSchFragment extends Fragment {
	...
	ComeNoEndSchAdapter adapter = null;
	Context context;
	...
	private void loadData() {
		...
		try {
			...
			otherlist = application.queryAllSchData(44, 0, 0);
			yestodaylist = application.queryAllSchData(45, 0, 0);
			todaylist = application.queryAllSchData(46, 0, 0);
			tomorrowlist = application.queryAllSchData(47, 0, 0);
			inweeklist = application.queryAllSchData(48, 0, 0);
			outweeklist = application.queryAllSchData(49, 0, 0);
	...
	protected void setAdapter() {
		adapter = new ComeNoEndSchAdapter(context, mList,
