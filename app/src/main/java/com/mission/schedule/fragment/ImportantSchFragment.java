...
public class ImportantSchFragment extends Fragment implements OnClickListener {
	...
	private void init() {
		...
		try {
			allList = application.queryAllSchData(24, 0, 0);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void setAdapter() {
		adapter = new ImportantSchAdapter(context, mList,
