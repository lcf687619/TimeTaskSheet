...
import com.mission.schedule.activity.AddNewFocusShareRepeatActivity;
import com.mission.schedule.activity.EditNewFocusShareRepeatActivity;
...
public class NewFocusShareRepeatFragment extends BaseFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		layoutview = inflater.inflate(R.layout.activity_newfocussharerepeat,
				container, false);
		return layoutview;
	}
	...
	private void init() {
		...
		repeat_listview = (SwipeXListViewNoHead) layoutview
				.findViewById(R.id.repeat_listview);
	...
	private void loadData() {
		...
		mList.clear();
		allList.clear();
		allList = app.QueryNewFocusData(6, NewFocusShareEditActivity.been.id);
		try {
