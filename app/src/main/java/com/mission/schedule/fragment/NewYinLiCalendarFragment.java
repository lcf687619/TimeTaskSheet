...
import com.mission.schedule.adapter.NewYinLiCalendarGridViewAdapter;
...
public class NewYinLiCalendarFragment extends Fragment implements OnTouchListener {
...
//					return false;
	...
	private NewYinLiCalendarGridViewAdapter gAdapter;
	private NewYinLiCalendarGridViewAdapter gAdapter1;
	private NewYinLiCalendarGridViewAdapter gAdapter3;
	// 顶部按钮
...
//				list.remove(0);
	...
	private void CreateGirdView() {
		...
		gAdapter1 = new NewYinLiCalendarGridViewAdapter(getActivity(), tempSelected1, width,
				handler,"",strlist);
		gView1.setAdapter(gAdapter1);// 设置菜单Adapter
		gView1.setId(calLayoutID);

		gView2 = new CalendarGridView(getActivity());
		gAdapter = new NewYinLiCalendarGridViewAdapter(getActivity(), tempSelected2, width,
				handler,"",strlist);
		...
		gAdapter3 = new NewYinLiCalendarGridViewAdapter(getActivity(), tempSelected3, width,
				handler,"",strlist);
...
//			paint.setFakeBoldText(true);
	...
	public void onEventMainThread(FristFragment event) {
		...
		if ("6".equals(msg)) {
			...
			tempSelected1.add(Calendar.MONTH, -1);
			gAdapter1 = new NewYinLiCalendarGridViewAdapter(getActivity(), tempSelected1,
					width, handler, "", strlist);
			gView1.setAdapter(gAdapter1);// 设置菜单Adapter

			gAdapter = new NewYinLiCalendarGridViewAdapter(getActivity(), tempSelected2,
					width, handler, "", strlist);
			gView2.setAdapter(gAdapter);// 设置菜单Adapter

			tempSelected3.add(Calendar.MONTH, 1);
			gAdapter3 = new NewYinLiCalendarGridViewAdapter(getActivity(), tempSelected3,
					width, handler, "", strlist);
			gView3.setAdapter(gAdapter3);// 设置菜单Adapter
