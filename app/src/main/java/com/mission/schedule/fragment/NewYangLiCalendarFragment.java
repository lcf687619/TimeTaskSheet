...
import com.mission.schedule.adapter.NewCalendarGridViewAdapter;
...
public class NewYangLiCalendarFragment extends Fragment implements OnTouchListener {
	...
	private NewCalendarGridViewAdapter gAdapter;
	private NewCalendarGridViewAdapter gAdapter1;
	private NewCalendarGridViewAdapter gAdapter3;
	// 顶部按钮
	...
	private void CreateGirdView() {
		...
		gAdapter1 = new NewCalendarGridViewAdapter(getActivity(), tempSelected1,
		...
		gAdapter = new NewCalendarGridViewAdapter(getActivity(), tempSelected2,
				width, handler, "", strlist);
		...
		gAdapter3 = new NewCalendarGridViewAdapter(getActivity(), tempSelected3,
				width, handler, "", strlist);
		...
		public void onClick(View v) {
			...
			case R.id.delete_tv:
				if (type == 1) {
					...
					Calendar tempSelected2 = Calendar.getInstance(); // 临时
					tempSelected2.setTime(calStartDate.getTime());
					gAdapter = new NewCalendarGridViewAdapter(getActivity(),
