...
public class TagAllSchFragment extends Fragment {
	...
	private void loadData() {
		...
		try {
			...
			if (!"0".equals(TagSchSerachActivity.tagId)) {
				...
				otherlist = application.queryAllSchData(50, 0, type);
				yestodaylist = application.queryAllSchData(51, 0, type);
				todaylist = application.queryAllSchData(52, 0, type);
				tomorrowlist = application.queryAllSchData(53, 0, type);
				inweeklist = application.queryAllSchData(54, 0, type);
				outweeklist = application.queryAllSchData(55, 0, type);
