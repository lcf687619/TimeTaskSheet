...
public class YinLiCalendarGridViewAdapter extends BaseAdapter {
	...
	// construct
	public YinLiCalendarGridViewAdapter(Activity a, Calendar cal, int width,
	...
	public YinLiCalendarGridViewAdapter(Activity a) {
		activity = a;
		resources = activity.getResources();
