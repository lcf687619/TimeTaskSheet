...
public class NewCalendarGridViewAdapter extends BaseAdapter {
	...
	// construct
	public NewCalendarGridViewAdapter(Activity a, Calendar cal, int width,
	...
	public NewCalendarGridViewAdapter(Activity a) {
		activity = a;
		resources = activity.getResources();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (iMonth == iMonthViewCurrentMonth) {
			...
			if (map.get(position)) {
				...
				txtDay.setBackgroundColor(resources.getColor(R.color.white));
				txtDay.setTextColor(resources.getColor(R.color.black));
			}
		}
		if (!"".equals(monthday)) {
