...
public class ImportantSchAdapter extends CommonAdapter<Map<String, String>>
	...
	public ImportantSchAdapter(Context context,
			List<Map<String, String>> lDatas, int layoutItemID,
			Handler handler, SwipeXListView swipeXlistview, int width) {
