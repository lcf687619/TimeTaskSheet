...
public class NewYinLiCalendarGridViewAdapter extends BaseAdapter {
	...
	// construct
	public NewYinLiCalendarGridViewAdapter(Activity a, Calendar cal, int width,
		...
		lunarList = a.getResources().getStringArray(R.array.lunarstr);
		setChooseData();
	}

	public NewYinLiCalendarGridViewAdapter(Activity a) {
		activity = a;
		resources = activity.getResources();
