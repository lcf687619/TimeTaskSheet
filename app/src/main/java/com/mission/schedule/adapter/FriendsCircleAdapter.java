...
public class FriendsCircleAdapter extends BaseAdapter {
	...
	public FriendsCircleAdapter(Context context, List<FriendsCircleBean> mList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		FriendsCircleBean bean = mList.get(position);
		ViewHolder viewHolder = null;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.adapter_friendscircle,
					null);
		...
		viewHolder.time_tv.setText(DateUtil.formatDate(
				DateUtil.parseDate(bean.cDate)).substring(5, 10)
				+ " " + bean.cTime);
